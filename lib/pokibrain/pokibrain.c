...
void pokibrain_think(void)
{
    ...
    {
        .robot_position = {.angle = 0,.coordinates={0,0}},
        .time = 0, // TODO: TIMER
...
void pokibrain_init(pokibrain_task_t * tasks, uint32_t number_of_tasks, pokibrain_user_context_t * world_context)
{
    ...
    brain.thread_id = k_thread_create(&brain.thread, stack, POKIBRAIN_STACK_SIZE,
                                      pokibrain_task, NULL, NULL, NULL, POKIBRAIN_TASK_PRIORITY, 0, K_NO_WAIT);
